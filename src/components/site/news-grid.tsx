        ...
        <div className="flex flex-col">
          {FEATURED.map((item, i) => (
            ...
            >
              ...
              >
                <div className="relative aspect-video w-full overflow-hidden border-2 border-black/40 transition-shadow duration-300 group-hover:shadow-[0_0_0_3px_var(--color-primary)] lg:w-1/2">
                  <img
                    src={item.cover}
                    alt=""
                    aria-hidden
                    className={cn(
                      'absolute inset-0 size-full bg-gradient-to-br object-cover opacity-90 transition-transform duration-500 group-hover:scale-105',
                      item.gradient,
                    )}
                  />
